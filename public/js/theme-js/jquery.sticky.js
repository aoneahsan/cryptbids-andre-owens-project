...
(function(i, t) {
    ...
    (n = function(n, e) {
        ...
        var r = function() {
                return (
                    (a = s._findMultiplier()),
                    s.$el.on("click", s.options.elements.nav + " a", function(
                        i
                    ) {
                        i.preventDefault(),
                            s.stop(),
            ...
            h = {
                containers: function() {
                    s.init
                        ...
                        1 === s.size() &&
                            s.$el.find(s.options.elements.nav).hide();
                },
                images: function() {
                    var i = s.$container
                        .find("img")
                        .not(s.options.elements.preserve);
                    i
                        .removeAttr("width")
                        .removeAttr("height")
                        .css({
        ...
        var d = {
            ...
            l = {
                ...
                _events: function() {
                    s.$el.on(
                        "click",
                        s.options.elements.pagination + " a",
                        function(i) {
                            i.preventDefault();
                            var t,
            ...
            animate: function(t, n) {
                ...
                if (
                    ...
                    if (
                        ...
                        e.size() > 1 &&
                            e.pagination._setCurrent(s.upcoming_slide),
